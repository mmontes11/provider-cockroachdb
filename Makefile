# ====================================================================================
# Setup Project
PROJECT_NAME := provider-cockroachdb
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider CockroachDB CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider CockroachDB controllers
...
# This target prepares repo for your provider by replacing all "cockroachdb"
